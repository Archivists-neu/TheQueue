...
def get_api_data(endpoint):
    """
    Sends a GET request to the Flask API.

    Returns an empty list if the request fails so that the
    dashboard can still load without crashing.
    """
    ...
    try:
        ...
        st.error(
            f"Unable to load data from {endpoint}."
        )
